export const stages = [
  // -------- Stage 1 --------
  {
    ...
    outcomes: [
      ...
      { keywords: ["motor", "cycle", "car", "drive", "uber", "ola", "taxi", "rapido"], score: 3, text: ["🚗💨 You used your own or hire vehicle to get there quickly!\n\nYou arrive super comfortable and right on time! ⏰\nYour crush notices: \"Oh, you came by car? I usually try to avoid that for short distances...\" 😅\n\nQuick and convenient, but they seem a little disappointed! 😬\nYour crush is wondering if you both share the same values... 🤔💭\n"] }
    ],
    fallback: { score: -4, text: ["🤔 Not sure if you are meeting the expectations of your Date. No worries, there are other stages to catch up.\n\nYour crush sends another text: \"Hey, you on your way?\" 📱\nDon’t change your travel plans. Your crush is eagerly waiting to meet you.\n"] }
  },
  ...
  // -------- Stage 2 --------
  {
    ...
    outcomes: [
      { keywords: ["vegan", "plant", "salad", "veggies", "organic", "local", "zero waste", "zero-waste", "mindful", "healthy", "greens", "samosa", "pakora", "vada", "pav", "panipuri", "water", "paani", "rolls", "momos", "momo", "fries", "wedges", "bhel", "chat", "chaat", "puri", "balls", "idli", "wada", "jilebi", "juice", "popcorn", "shake", "smoothie", "coffee", "Tea", "fruits", "bhajji", "mirchi", "cutlet", "pakoda", "dabeli", "kachori", "cutlet", "dhokla", "toast", "biscuit", "kabab", "paneer", "bonda", "bread", "sandwich", "manchuria", "roti", "parota", "butter", "65", "paneer", "idly", "dosa", "pizza", "burrito", "cheese", "muruku","murukku", "punugulu", "bonda", "poha", "tikka", "upma", "paratha", "pesarattu", "tamota", "yello", "rice", "dahi", "cake", "pastry", "puff", "patis", "ragada", "patties", "chivda", "mixture", "kara", "expresso", "combo", "cold", "drink", "soft", "coke", "cola", "diet", "energy", "millet", "millets", "ragi", "boost", "bournavita", "Badam", "jonna", "jowar", "khakra", "chikki", "roast", "sev", "punch", "utappam", "masala", "oats","sprouts", "moong", "dal", "eggless", "sugar", "free",  "burji", "soya", "uggani", "vuggani", "cookies", "soup", "french", "croissants", "salad", "green", "tea", "black", "noodles", "noodle", "hakka", "nuggets", "donuts", "donut", "nugget", "khichdi", "kebab",  "pongal", "panir", "aloo", "bhujia"], score: 10, text: ["🥗🌱 You confidently order the vegan bowl with fresh veggies!\n\nYour crush's face literally LIGHTS UP! 😍\n\"No way! I'm plant-based too! This is so rare to find!\" 💚\n\nYou both geek out about your favorite vegan spots! 🌿\nThe conversation flows naturally – you're totally vibing! ✨\nYour crush keeps smiling and leaning in closer! 💕\n\nPlant-based power couple energy unlocked! 🌟\n"] },

      { keywords: ["vegetarian", "paneer", "cheese", "meatless" , "herbivore", "veggie", "fried"], score: 7, text: ["🧀🥪 You order something vegetarian – paneer tikka sounds perfect!\n\nYour crush nods approvingly! 😊\n\"Nice choice! I try to avoid meat too. Better for the planet, you know?\" 🌍\n\nYou both chat about reducing your carbon footprint! 💚\nThe conversation is flowing really well! There's definitely a connection here! ✨\nYour crush seems happy you made a conscious choice! 💕\n\nNot bad at all – you're on the same wavelength! 🌿\n"] },

      { keywords: ["chicken", "fish", "meat", "omlette", "omlet", "prawn", "eggs", "murg", "anda"], score: 4, text: ["🍗🐟 You order chicken or fish – it's your favorite!\n\nYour crush raises an eyebrow slightly... 🤔\n\"Oh, you eat meat? I mean, that's cool... I've been trying to cut down though.\" 😅\n\nThere's a brief awkward pause... 😬\nYour crush is polite but you can sense they're a bit disappointed! 💭\nThe conversation continues but the energy shifted a little! ⚡\n\nNot a dealbreaker, but maybe not perfectly aligned! 🌍\n"] },

      { keywords: ["beef", "steak", "burger", "red", "meat", "mutton", "pork"], score: 2, text: ["🍔🥩 You order the beef burger – you're craving it!\n\nYour crush's smile fades a bit... 😕\n\"Oh... beef? That's actually got the highest carbon footprint...\" They look genuinely concerned! 🌍\n\nAwkward silence for a moment... 😬\nYour crush tries to change the subject but seems less enthusiastic now! 💔\nYou can tell this matters a lot to them! 💭\n\nYikes... maybe you should've checked their vibe first! 🙈\n"] }
    ],
    fallback: { score: -4, text: ["🤔 You are creative with your food choices! Maybe your crush is having other recipes in mind.!\n\nYour crush giggles: \" I am OK with that. I will order some vegetarian food.\" 😄\nOrder done. Time to kill time innovatively till food arrives⏰\n"] }
  },
